            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/vaibhavgupta03"
                                ...
                                <li>
                                     <a
                                        href="https://www.linkedin.com/in/vaibhav-gupta-45a340225/"
                                        className="hover:underline hover:text-orange-700"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center">
                        © 2023
                        <a href="https://hashnode.com/@vaibhavgupta" className="hover:underline">
                            vaibhavgupta 
                        </a>
                        . All Rights Reserved.
                    </span>
